...
- (void)addInformationOnScrollView {
    ...
    if ([arrayOfDrunkSakeID containsObject:[NSNumber numberWithInt:sakeID]]) {
        ...
        labelOfSakeDetail.text = @"八海山は新潟県南魚沼市長森に本社を置く八海醸造によって1922年から作られている。新潟県の地酒を代表する銘柄で、日本国内でかなり流通している日本酒の銘柄の一つでもある。仕込水『雷電様の清水』など酒造りに最適の雪国魚沼の環境条件と「寒梅と八海山は兄弟蔵」と言われた酒造りの技で、淡麗辛口の酒質評価が高い食中酒。「どうすればよい酒ができるのか」という醸造技術は、明治時代までにほぼ確立されている中、普段のお酒の品質を少しでも高め、日本酒のスタンダードを高めていくことをモットーに毎年毎年、限りない最高品質を目指す。";
